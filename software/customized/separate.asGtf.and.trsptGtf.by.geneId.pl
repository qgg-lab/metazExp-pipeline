...
my ($inputAsGtf, $inputTrsptGtf, $outputDir);
...
# 按照geneId将属于该geneId的trspt并入
my (%trsptGtf, $trsptGtfHref, $geneId, @field, $line);
$trsptGtfHref = \%trsptGtf;
